...
namespace ProjectCalidadSoft.Controllers
{
    public class PacientesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellidos,Sexo,LugarNacimiento,FechaNacimieto,Ocupacion,TipoPaciente,Telefono,Correo,ContactoFamiliares,TipoSangre,Tutor,Estado,Peso,Altura")] Paciente paciente)
        {
            if (id != paciente.Id)
            {
                return NotFound();
